...
public class MqttService extends Service implements MqttTraceHandler {
    ...
    public void connect(String clientHandle, MqttConnectOptions connectOptions,
                        String invocationContext, String activityToken, Intent intent)
            throws MqttSecurityException, MqttException {
        MqttConnection client = getConnection(clientHandle);
        this.intent = intent;
        client.connect(connectOptions, null, activityToken);
//        Notification ntf = Notify.notifcation(getBaseContext(), true);
//        this.startForeground(101, ntf);
...
//        startForeground(1, createNotification());
    ...
    private Notification createNotification() {
        NotificationCompat.Builder builder=new NotificationCompat.Builder(this,"MQTTSericeChannel")
                .setContentTitle("Najification").setContentText("Najification is running")
    ...
    public void traceDebug(String tag, String message) {
        ...
        if (message.contains("Reconnect")) {
            Notification ntf = Notify.notifcation(getApplicationContext(), true);
            this.startForeground(101, ntf);
        } else if (message.contains("connectionLost")) {
            Notification ntf = Notify.notifcation(getApplicationContext(), false);
            this.startForeground(101, ntf);
            ...
            Notification ntf = Notify.notifcation(getApplicationContext(), false);
            this.startForeground(101, ntf);
        } else if (message.contains("connect success!")) {
            Notification ntf = Notify.notifcation(getApplicationContext(), true);
            this.startForeground(101, ntf);
    ...
    private void registerBroadcastReceivers() {
        if (networkConnectionMonitor == null) {
            ...
            System.out.println("@@inentfilter4 = " + "is call");
        ...
        if (Build.VERSION.SDK_INT < 14 /**Build.VERSION_CODES.ICE_CREAM_SANDWICH**/) {
            ...
            if (backgroundDataPreferenceMonitor == null) {
                ...
                registerReceiver(
                        backgroundDataPreferenceMonitor,intentFilter
                        );
            }
        }
    }
    ...
    public void connectAndSubscribe(
            ...
            String activityToken,
            Intent intent) throws MqttException {

        // Connect to the MQTT server
        connect(clientHandle, connectOptions, invocationContext, activityToken, intent);

        // Subscribe to the specified topic
        subscribe(clientHandle, topic, qos, invocationContext, activityToken);
    }
}
