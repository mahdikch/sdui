...
//        String ticker = contentTitle + " " + messageString;
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationChannel channel = new NotificationChannel(TAG, "najification", NotificationManager.IMPORTANCE_HIGH);
...
//        @SuppressLint("RemoteViewLayout") RemoteViews customView = new RemoteViews(context.getPackageName(),R.layout.custom_notification_view);
        ...
        views.setTextViewText(R.id.txtTitel,messageString);
//        views.setImageViewResource(R.id.logo,isconnect ? R.drawable.oval_connect :R.drawable.oval_disconnect);
        ...
        Bitmap dayBitmap = createDayBitmap(persianDate.getShDay(), 50,isconnect ? Color.parseColor("#3F51B5") : Color.parseColor("#ffcc0000"));
...
//        mNotificationManager.notify(MessageID, notification);
    ...
    public static Bitmap createDayBitmap(int dayNumber, int size, int color) {
